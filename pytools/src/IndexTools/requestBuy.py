...
def requestBuy():
    ...
    for idxName in indexDB.allIndices:
        ...
        idxData0 = fetch.fetchHistoryValue( 2016, 4, 27)
        idxData1 = fetch.fetchHistoryValue( 2016, 3, 27)
        idxData2 = fetch.fetchHistoryValue( 2016, 1, 27)
        idxData3 = fetch.fetchHistoryValue( 2015, 10, 27)
        idxData4 = fetch.fetchHistoryValue( 2015, 4, 27)
